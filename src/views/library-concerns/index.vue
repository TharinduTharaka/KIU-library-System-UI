<template>
  <div class="app-container">
    ...
    >
      <el-table-column label="REF ID" prop="id" sortable="custom" align="center" width="100" :class-name="getSortClass('id')">
      ...
      <el-table-column label="Documents" class-name="status-col" width="230">
        <template slot-scope="{row}">
